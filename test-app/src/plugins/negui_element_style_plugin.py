...
def elementStylesInfo():
    ...
    species_node_style3 = {'name' : "hexagon", 'type' : "nodestyle", 'category' : "Species", 'parent-category' : "Compartment", 'shapes' : [{'shape' : "polygon", 'fill' : "white", 'stroke' : "black", 'stroke-width' : 2, 'points' : [{'x' : -10.0, 'y' : -20}, {'x' : 10.0, 'y' : -20.0}, {'x' : 20.0, 'y' : 0.0}, {'x' : 10.0, 'y' : 20.0}, {'x' : -10.0, 'y' : 20.0}, {'x' : -20.0, 'y' : 0.0}]}]}
    
    reaction_node_style1 = {'name' : "simple_rect", 'type' : "nodestyle", 'category' : "Reaction", 'shapes' : [{'shape' : "rect", 'fill' : "white", 'stroke' : "black", 'stroke-width' : 2, "x": 0.0, "y": 0.0, "width": 25.0, "height": 25.0}]}

    reaction_node_style2 = {'name' : "simple_circle", 'type' : "nodestyle", 'category' : "Reaction", 'shapes' : [{'shape' : "ellipse", 'fill' : "white", 'stroke' : "black", 'stroke-width' : 2, "rx": 15.0, "ry": 15.0, "cx": 15.0, "cy": 15.0}]}
    ...
    return json.dumps({'items': [species_node_style1, species_node_style2, species_node_style3, reaction_node_style1, reaction_node_style2, reaction_edge_style3, species_reference_edge_style1, species_reference_edge_style2, species_reference_edge_style3, species_reference_edge_style4, species_reference_edge_style5]})
