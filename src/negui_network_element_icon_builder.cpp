...
// MyNetworkElementIconBuilderBase

MyNetworkElementIconBuilderBase::MyNetworkElementIconBuilderBase(MyNetworkElementStyleBase* style) {
    _style = style;
}

void MyNetworkElementIconBuilderBase::build() {
...
const QRectF MyNetworkElementIconBuilderBase::getIconExtents(QList<QGraphicsItem*> items) {
    QRectF extents;
...
const QIcon MyNetworkElementIconBuilderBase::icon() {
    return _icon;
}

MyNetworkElementStyleBase* MyNetworkElementIconBuilderBase::style() {
    return _style;
}

// MyNodeIconBuilder

MyNodeIconBuilder::MyNodeIconBuilder(MyNetworkElementStyleBase* style) : MyNetworkElementIconBuilderBase(style) {
...
MyEdgeIconBuilder::MyEdgeIconBuilder(MyNetworkElementStyleBase* style) : MyNetworkElementIconBuilderBase(style) {
...
MyArrowHeadIconBuilder::MyArrowHeadIconBuilder(MyNetworkElementStyleBase* style) : MyNetworkElementIconBuilderBase(style) {
...
MyTemplateIconBuilder::MyTemplateIconBuilder(MyNetworkElementStyleBase* style) : MyNetworkElementIconBuilderBase(style) {
