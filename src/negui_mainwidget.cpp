...
void MyNetworkEditorWidget::setWidgets() {
    ...
    ((MyModeMenu*)modeMenu())->setAddButtons(((MyInteractor*)interactor())->getAddModeButtons());
    ((MyModeMenu*)modeMenu())->setRemoveButton(((MyInteractor*)interactor())->getRemoveModeButton());
}
