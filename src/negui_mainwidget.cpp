...
void MyNetworkEditorWidget::setInteractions() {
    ...
    connect(((MyGraphicsScene*)((MyGraphicsView*)view())->scene()), SIGNAL(mouseLeftButtonIsReleased(const QPointF&)), (MyInteractor*)interactor(), SLOT(clearSelectionArea(const QPointF&)));
